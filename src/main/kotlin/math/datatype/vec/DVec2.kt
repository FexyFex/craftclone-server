...
data class DVec2(override var x: Double, override var y: Double): TVec2<Double>() {
    ...
    override operator fun plus(other: TVec2<Double>): TVec2<Double> = DVec2(this.x + other.x, this.y + other.y)
    override operator fun minus(other: TVec2<Double>): TVec2<Double> = DVec2(this.x - other.x, this.y - other.y)
    override operator fun times(other: TVec2<Double>): TVec2<Double> = DVec2(this.x * other.x, this.y * other.y)
    override operator fun div(other: TVec2<Double>): TVec2<Double> = DVec2(this.x / other.x, this.y / other.y)
